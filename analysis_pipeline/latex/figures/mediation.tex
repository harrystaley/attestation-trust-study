...
\draw[flow] (att) -- node[elab]{$a=0.419$} (trust);
\draw[flow] (trust) -- node[elab]{$b=0.195$} (rel);
\draw[weak, bend right=38] (att.south) to node[graylab, below]{$c'=0.026$ (n.s.)} (rel.south);
\end{tikzpicture}
