...
\addplot+[draw=llmline, fill=llmfill, line width=1pt] coordinates {(0,0.146)[.15] (1,0.072)[.07] (2,0.037)[.04]};
\addlegendentry{Reject}
\addplot+[draw=boxblue, fill=boxbluefill, line width=1pt] coordinates {(0,0.673)[.67] (1,0.742)[.74] (2,0.681)[.68]};
\addlegendentry{Verify}
\addplot+[draw=ragline, fill=ragfill, line width=1pt] coordinates {(0,0.181)[.18] (1,0.186)[.19] (2,0.282)[.28]};
\addlegendentry{Use}
\end{groupplot}
\end{tikzpicture}
